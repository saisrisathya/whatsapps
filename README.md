# WhatsApps using Yowsup

## List of Apps

- ChennaiBot: A rescue bot to connect people who need help with volunteers and care givers.
...
Here is what you need to know about WhatsApps using Yowsup 2.0 to get started: (Or quickly [jump to installation](#installation)):
